...
-- AI USE ACKNOWLEDGEMENT
-- AI USE ACKNOWLEDGEMENT
-- Google Gemini was used to create the job listings for ID's 10002 and greater. 
-- Job Listing 10000 and 10001 were crafted by hand and then fed into gemini where it was asked "Continue this pattern but with more job listings for a business that works with governments to roll out AI smart cameras across the city, give me 10 more job listings"
